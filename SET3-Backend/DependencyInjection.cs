    ...
    public static class DependencyInjection
    {
        ...
        public static IServiceCollection AddBackendServices(this IServiceCollection services, IConfiguration Configuration)
        {
            services.AddDbContext<Context>(options =>
            {
                ...
                var dbConnString = @"Data Source=localhost,1433;Initial Catalog=Set3Baza;User ID=SA;Password=prir0da#ajprir0da#aj;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;";
